...
service = Service('C:/Users/karan/Downloads/chromedriver-win64/chromedriver-win64/chromedriver.exe')  # Use full path if not in current directory
...
df.to_csv('books_selenium1.csv', index=False)
